    ...
    while done == 0:
        ...
        # Updated for PASSAGE KVN 19-Nov-2024
            ...
            if show_dispersed:  # MB
                panDispersed_PASSAGE(obj, par, path_to_drizzled_images=args.drizzled_images_path, path_to_region_files=args.region_file_path)

        # reload full iamges
        # Updated for PASSAGE KVN 19-Nov-2024
        elif option.strip().lower() == "reload":
            showDirect_PASSAGE(par, path_to_drizzled_images=args.drizzled_images_path, path_to_region_files=args.region_file_path)
            showSpec2D_PASSAGE(par, obj, path_to_spec2D=args.spec2D_path)
